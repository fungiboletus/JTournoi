...
public abstract class Moteur {
	...
	public static void setEpreuve(Tournoi t, TypeEpreuve te,
			...
			throws NombreDeParticipantInsufisantException,
			EpreuveDejaExistanteException, TournoiDejaLanceException {
	 ...
	 */
	public HashMap<TypeEpreuve,ArrayList<Match>> getCurrentsMatchByEpreuve(Tournoi t) throws TournoiNonLanceException{
	 ...
	 * @throws TournoiNonLanceException 
	 */
	public static ArrayList<Match> getCurrentMatch(Tournoi t) throws TournoiNonLanceException{
	 ...
	 * @throws TournoiNonLanceException 
	 */
	public static Match getMatch(Arbitre a, Tournoi t) throws TournoiNonLanceException{
