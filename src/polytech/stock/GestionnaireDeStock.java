...
/**
 * @author Antoine Pultier Le gestionnaire de stock est une interface qui va
 *         permettre d'utiliser du polymorphisme.
 * 
 *         Les méthodes de gestion du stock sont identiques que l'on ai du XML,
 *         du SQL, du Json, de la sérialisation, ou n'importe quoi d'autre.
 */
public interface GestionnaireDeStock {
	 ...
	 * @param <CLASS_TYPE>
	 * @param liste
	 *            Liste des objets à enregistrer dans le stock.
	 */
	 ...
	 * 
	 * @param element
	 *            Informations permettant de construire l'objet.
	 ...
	 * 
	 * @param element
	 *            Objet à transformer pour qu'il puisse être inséré dans le
	 *            stock.
