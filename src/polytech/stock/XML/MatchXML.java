...
public class MatchXML extends GestionXML
{
	...
	public Object construireDepuisStock(Object element)
	{
		...
		Match a = new Match(
				Stock.getEquipeParId(Integer.parseInt(equipe_1.getAttributeValue("id"))),
				Stock.getEquipeParId(Integer.parseInt(equipe_2.getAttributeValue("id"))),
				Stock.getArbitreParId(Integer.parseInt(arbitre.getAttributeValue("id"))),
				Integer.parseInt(noeud.getAttributeValue("numero")),
				Integer.parseInt(noeud.getAttributeValue("tour"))
			);
